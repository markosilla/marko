...
/* Define to 1 if you have the `cares' library (-lcares). */
...
#define HAVE_LIBGPR 1

/* Define to 1 if you have the `grpc' library (-lgrpc). */
#define HAVE_LIBGRPC 1

/* Define to 1 if you have the `grpc_cronet' library (-lgrpc_cronet). */
#define HAVE_LIBGRPC_CRONET 1

/* Define to 1 if you have the `grpc_unsecure' library (-lgrpc_unsecure). */
#define HAVE_LIBGRPC_UNSECURE 1
...
/* Name of package */
#define PACKAGE "marko"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "no-reply@ericsson.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "MARKO"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MARKO v0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "marko"
